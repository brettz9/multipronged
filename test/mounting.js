...
describe('app.use()', function(){
  ...
  // Thanks, @altworowsky!
  // @see https://github.com/senchalabs/connect/pull/808/files
  ...
  it('should mount an array with a route', function(done){
    app.use('/blog', [
      function(req, res, next){
        assert.equal(req.url, '/');
        res.blog = 'blog';
  ...
  it('should mount an array without polyfills', function(done){
    // Temporarily delete items our code polyfills (giving us full coverage)
